<template>
  <el-drawer v-model="drawerVisible" :destroy-on-close="true" size="460px" :show-close="false">
    <template #header>
    ...
    >
      <el-form-item label="分类编号" prop="username">
        <el-input v-model="drawerProps.row!.username" placeholder="请输入订单编号" clearable />
      </el-form-item>
      <el-form-item label="分类名称" prop="gender">
