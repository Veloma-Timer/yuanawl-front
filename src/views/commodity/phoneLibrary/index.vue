  ...
  <div class="table-box">
    ...
    >
      ...
      <template #operation="scope">
        ...
        <el-button type="danger" v-if="BUTTONS.del" link :icon="Delete" @click="deleteAccount(scope.row)">删除 </el-button>
      </template>
    </ProTable>
...
import { CirclePlus, Upload, View, Document, Download, Delete } from "@element-plus/icons-vue";
import {
  addPhone,
  deletePhone,
  getPhoneList,
